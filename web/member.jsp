...
<link rel="stylesheet" href="nivo-slider/default/default.css" type="text/css" media="screen" /><link rel="stylesheet" href="nivo-slider/default/nivo-slider.css" type="text/css" media="screen" />
 ...
 <%
        ...
        <script>alert('Member Registered Successfully');</script>
        <%}
...
<center><h1>Anonymous and Traceable Group Data Sharing in Cloud Computing</h1></center>
	...
	<center><p><font size="5" color="black">Member Login </font></p><br/></center>
     
    <form action="memberact.jsp" method="post">
    ...
    <br/>
    <center><a href="memberreg.jsp"><font color="black" style="font-size: 21px">Click Here for Registration </font></a> </center>  
